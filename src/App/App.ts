...
export class App {
  ...
  constructor(parent: HTMLElement) {
    ...
    this.toggleButton = new BaseComponent({classNames: "toggle-button", tagName: "button", textContent: "switch theme", parentNode: this.calculatorContainer.getElement()})
...
if(this.appContainer.className === 'app-container-light') {
  ...
  this.keyboard.buttons.forEach((button)=> {button.setClassName("button-dark")})
  ...
  this.keyboard.buttons.forEach((button)=> {button.removeClassName("button-dark")})
